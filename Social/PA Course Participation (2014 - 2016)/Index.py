...
dataset_id = "d_01ad15c4d10ca87328f6af80b2ffbe82"
...
plt.title("PA Course Participation (2014 - 2016)")
plt.xlabel("Year")
...
plt.savefig("C:/OtherProjects/Data-Analysis-Projects/Social/PA Course Participation (2014 - 2016)/Index.png")
plt.show()