...
dataset_id = "d_7f2c2c8e09242be1493e9a6db511bd50"
...
plt.title("PA Course Participation (2017 - 2020)")
plt.xlabel("Year")
...
plt.savefig("C:/OtherProjects/Data-Analysis-Projects/Social/PA Course Participation (2017 - 2020)/Index.png")
plt.show()